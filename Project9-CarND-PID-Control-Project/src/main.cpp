      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // calculates average of last 25 instances
          SS.emplace_back(steer_value);
          if(SS.size() > 25)SS.erase(SS.begin());
          steer_value = std::accumulate(SS.begin(), SS.end(),0.0)/SS.size();
